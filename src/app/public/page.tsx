...
export default function PublicPage() {
  ...
  return (
    <div className={darkMode ? 'min-h-screen bg-[#001117]' : 'min-h-screen bg-white'}>
      ...
      <nav className={darkMode ? 'sticky top-0 z-40 bg-[#001117]/95 backdrop-blur-sm border-b border-[#E6A854]/20 shadow-sm' : 'sticky top-0 z-40 bg-white border-b border-[#E5E7EB] shadow-sm'}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className={darkMode ? 'flex items-center gap-1.5 bg-[#E6A854]/10 rounded-full p-1 border border-[#E6A854]/20' : 'flex items-center gap-1.5 bg-slate-100 rounded-full p-1'}>
                <button
                  onClick={() => {
                    setViewMode('rent')
                    setShowFavorites(false)
                  ...
                  className={cn(
                    ...
                    viewMode === 'rent' && !showFavorites
                      ? darkMode 
                        ? 'bg-[#E6A854] text-[#001117] shadow-sm'
              ...
              <button
                ...
                className={cn(
                  ...
                  (showFavorites || activeTab === 'favorites')
                    ? darkMode
                      ? 'bg-[#E6A854]/20 text-[#E6A854] border border-[#E6A854]/30'
                      : 'bg-red-50 text-red-600 border border-red-200'
                    : darkMode
                    ? 'bg-[#E6A854]/10 text-slate-400 hover:bg-[#E6A854]/20 border border-[#E6A854]/20'
                    : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
                )}
              >
                <Heart className={cn('w-3.5 h-3.5 sm:w-4 sm:h-4', (showFavorites || activeTab === 'favorites') && (darkMode ? 'fill-[#E6A854]' : 'fill-red-600'))} />
                <span className="hidden sm:inline">{lang === 'id' ? 'Favorit' : 'Favorites'}</span>
                {favorites.length > 0 && (
                  <span className={darkMode ? 'absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-[#E6A854] text-[#001117] text-[10px] sm:text-xs font-bold rounded-full flex items-center justify-center' : 'absolute -top-1 -right-1 w-4 h-4 sm:w-5 sm:h-5 bg-red-500 text-white text-[10px] sm:text-xs font-bold rounded-full flex items-center justify-center'}>
                    {favorites.length}
                  </span>
                )}
              </button>
            ...
            {/* Right - Dark Mode, Language Toggle & Account */}
            <div className="flex items-center gap-2">
              {/* Dark Mode Toggle */}
              <button
              ...
              <button
                ...
                className={darkMode ? 'flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 bg-[#E6A854]/10 rounded-full text-xs font-semibold text-[#E6A854] hover:bg-[#E6A854]/20 transition border border-[#E6A854]/20' : 'flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 bg-slate-100 rounded-full text-xs font-semibold text-slate-700 hover:bg-slate-200 transition'}
              >
              ...
              <button
                ...
                className={darkMode ? 'hidden sm:flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-[#E6A854] to-[#D4AF37] rounded-full text-xs font-semibold text-[#001117] hover:shadow-lg hover:shadow-[#E6A854]/20 transition' : 'hidden sm:flex items-center gap-2 px-3 py-1.5 bg-slate-800 rounded-full text-xs font-semibold text-white hover:bg-slate-900 transition'}
              >
                <span>Admin</span>
              </button>
              ...
              <button
                ...
                className={darkMode ? 'hidden sm:flex items-center gap-2 px-4 py-1.5 bg-[#E6A854]/10 rounded-full text-xs font-semibold text-[#E6A854] hover:bg-[#E6A854]/20 transition border border-[#E6A854]/20' : 'hidden sm:flex items-center gap-2 px-4 py-1.5 bg-slate-100 rounded-full text-xs font-semibold text-slate-700 hover:bg-slate-200 transition'}
              >
      ...
      {!showFavorites && (
        <div className={darkMode ? 'relative bg-[#001117] border-b border-[#E6A854]/20 overflow-hidden' : 'relative bg-gradient-to-br from-slate-50 via-slate-100 to-slate-50 border-b border-[#E5E7EB] overflow-hidden'}>
          {/* Background Image */}
          <div className="absolute inset-0 z-0">
            ...
            />
            <div className={darkMode ? 'absolute inset-0 bg-gradient-to-br from-[#001117]/95 via-[#001117]/90 to-[#001117]/85' : 'absolute inset-0 bg-gradient-to-br from-slate-50/90 via-slate-100/90 to-slate-50/90'} />
          </div>

          {/* Content */}
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-16 text-center">
            <h1 className={darkMode ? 'text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4 leading-tight' : 'text-2xl sm:text-4xl md:text-5xl font-bold text-slate-900 mb-3 sm:mb-4 leading-tight'}>
              {viewMode === 'rent' ? t('heroTitleRent', lang) : t('heroTitleInvest', lang)}
            </h1>
            <p className={darkMode ? 'text-sm sm:text-lg text-slate-400 mb-6 sm:mb-10 max-w-2xl mx-auto px-4' : 'text-sm sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto px-4'}>
              {viewMode === 'rent' ? t('heroSubtitleRent', lang) : t('heroSubtitleInvest', lang)}
            </p>

            {/* Search bar - Mobile Optimized */}
            <div className="relative max-w-2xl mx-auto">
              <div className={darkMode ? 'bg-[#001117]/95 backdrop-blur-sm rounded-2xl sm:rounded-full shadow-xl border border-[#E6A854]/30 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-0 p-4 sm:px-6 sm:py-4' : 'bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-full shadow-xl border border-[#E5E7EB] flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-0 p-4 sm:px-6 sm:py-4'}>
                <div className="flex items-center flex-1">
                  <Search className={darkMode ? 'w-5 h-5 text-[#E6A854] mr-3 flex-shrink-0' : 'w-5 h-5 text-slate-400 mr-3 flex-shrink-0'} />
                  <input
                    type="text"
                    placeholder={t('searchPlaceholder', lang)}
                    value={search}
                    onChange={(e) => setSearch(e.target.value)}
                    className={darkMode ? 'flex-1 text-white placeholder-slate-500 focus:outline-none text-sm sm:text-base bg-transparent' : 'flex-1 text-slate-700 placeholder-slate-400 focus:outline-none text-sm sm:text-base bg-transparent'}
                  />
                </div>
                <button className={darkMode ? 'w-full sm:w-auto sm:ml-3 px-6 py-2.5 sm:py-2 bg-gradient-to-r from-[#E6A854] to-[#D4AF37] text-[#001117] text-sm font-semibold rounded-xl sm:rounded-full hover:shadow-lg hover:shadow-[#E6A854]/30 transition' : 'w-full sm:w-auto sm:ml-3 px-6 py-2.5 sm:py-2 bg-gradient-to-r from-[#D4AF37] to-[#E6A854] text-white text-sm font-semibold rounded-xl sm:rounded-full hover:shadow-lg transition'}>
                  {t('searchButton', lang)}
                </button>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10 pb-24 sm:pb-10">
        ...
        {showFavorites && (
          <div className="mb-6 sm:mb-8">
            <h1 className={darkMode ? 'text-2xl sm:text-3xl font-bold text-white mb-2' : 'text-2xl sm:text-3xl font-bold text-slate-900 mb-2'}>
              {lang === 'id' ? '❤️ Properti Favorit Saya' : '❤️ My Favorite Properties'}
            </h1>
            <p className={darkMode ? 'text-sm sm:text-base text-slate-400' : 'text-sm sm:text-base text-slate-600'}>
              {lang === 'id' 
              ...
              {filterOptions.map((opt) => (
                <button
                  ...
                  className={cn(
                    ...
                    filter === opt.value
                      ? darkMode
                        ? 'bg-gradient-to-r from-[#E6A854] to-[#D4AF37] text-[#001117] border-[#E6A854] shadow-md'
                        : 'bg-slate-900 text-white border-slate-900 shadow-md'
                      : darkMode
                      ? 'bg-[#001117]/50 border-[#E6A854]/30 text-slate-400 hover:bg-[#E6A854]/10'
        ...
        {!showFavorites && (
          <div className={darkMode ? 'mb-6 sm:mb-8 bg-[#001117]/50 rounded-2xl border border-[#E6A854]/30 p-4 sm:p-6' : 'mb-6 sm:mb-8 bg-white rounded-2xl border border-[#E5E7EB] p-4 sm:p-6'}>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {/* Sort By */}
              <div>
                <label className={darkMode ? 'block text-xs font-semibold text-[#E6A854] mb-2' : 'block text-xs font-semibold text-slate-700 mb-2'}>
                  {lang === 'id' ? 'Urutkan' : 'Sort By'}
                </label>
                <select
                  value={sortBy}
                  onChange={(e) => setSortBy(e.target.value as any)}
                  className={darkMode ? 'w-full px-3 py-2 border border-[#E6A854]/30 rounded-xl text-sm text-white bg-[#001117]/50 focus:outline-none focus:ring-2 focus:ring-[#E6A854]/50 focus:border-[#E6A854]' : 'w-full px-3 py-2 border border-[#E5E7EB] rounded-xl text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#E6A854]/20 focus:border-[#E6A854]'}
                >
            ...
            <button
              ...
              className={darkMode ? 'mt-4 text-xs font-semibold text-[#E6A854] hover:text-[#D4AF37]' : 'mt-4 text-xs font-semibold text-[#D4AF37] hover:text-[#E6A854]'}
            >
        ...
        {!showFavorites && (
          <div className="mb-4 sm:mb-6">
            <p className={darkMode ? 'text-xs sm:text-sm text-slate-400' : 'text-xs sm:text-sm text-slate-500'}>
              <span className={darkMode ? 'font-semibold text-white' : 'font-semibold text-slate-900'}>{displayProperties.length}</span> {t('propertiesAvailable', lang)}
              {sortBy !== 'default' && (
                <span className={darkMode ? 'ml-2 text-[#E6A854]' : 'ml-2 text-[#D4AF37]'}>
      ...
      <footer className={darkMode ? 'bg-[#001117] border-t border-[#E6A854]/20 mt-12 sm:mt-20' : 'bg-slate-50 border-t border-[#E5E7EB] mt-12 sm:mt-20'}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className={darkMode ? 'text-xs sm:text-sm text-slate-400' : 'text-xs sm:text-sm text-slate-500'}>{t('footerTagline', lang)}</p>
            </div>
            <div>
              <h3 className={darkMode ? 'font-semibold text-white mb-2 sm:mb-3 text-xs sm:text-sm' : 'font-semibold text-slate-800 mb-2 sm:mb-3 text-xs sm:text-sm'}>{t('about', lang)}</h3>
              <ul className={darkMode ? 'space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-slate-400' : 'space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-slate-500'}>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('aboutUs', lang)}</a></li>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('career', lang)}</a></li>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('blog', lang)}</a></li>
              </ul>
            </div>
            <div>
              <h3 className={darkMode ? 'font-semibold text-white mb-2 sm:mb-3 text-xs sm:text-sm' : 'font-semibold text-slate-800 mb-2 sm:mb-3 text-xs sm:text-sm'}>{t('support', lang)}</h3>
              <ul className={darkMode ? 'space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-slate-400' : 'space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-slate-500'}>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('helpCenter', lang)}</a></li>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('contact', lang)}</a></li>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('faq', lang)}</a></li>
              </ul>
            </div>
            <div>
              <h3 className={darkMode ? 'font-semibold text-white mb-2 sm:mb-3 text-xs sm:text-sm' : 'font-semibold text-slate-800 mb-2 sm:mb-3 text-xs sm:text-sm'}>{t('legal', lang)}</h3>
              <ul className={darkMode ? 'space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-slate-400' : 'space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-slate-500'}>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('terms', lang)}</a></li>
                <li><a href="#" className={darkMode ? 'hover:text-[#E6A854]' : 'hover:text-slate-900'}>{t('privacy', lang)}</a></li>
              </ul>
            </div>
          </div>
          <div className={darkMode ? 'border-t border-[#E6A854]/20 pt-4 sm:pt-6 text-center text-xs sm:text-sm text-slate-400' : 'border-t border-[#E5E7EB] pt-4 sm:pt-6 text-center text-xs sm:text-sm text-slate-400'}>
